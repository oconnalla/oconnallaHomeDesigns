...
(function( $ ) {
  ...
  $.Shop.prototype = {
    init: function() {
      ...
      this.cartPrefix = 'decor-'; // Prefix string to be prepended to the cart's name in the session storage
      ...
      this.paypalBusinessEmail = 'oconnalla@email.com'; // Your Business PayPal's account email address
